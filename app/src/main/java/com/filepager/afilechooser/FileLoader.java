...
import com.filepager.afilechooser.utils.FileUtils;
...
public class FileLoader extends AsyncTaskLoader<List<File>> {
	...
	public FileLoader(Context context, String path, String allowedExtension) {
		...
		showHidden=PreferenceManager.getDefaultSharedPreferences(context).getBoolean(SettingsActivity.KEY_HIDDENFILES, false);
	}

	@Override
	public List<File> loadInBackground() {
		return FileUtils.getFileList(mPath, mAllowedExtension,showHidden);
	}
