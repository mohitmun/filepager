...
package com.filepager.afilechooser.utils;
...
public class FileUtils {
	 ...
	 * @author paulburke
	 */
	public static List<File> getFileList(String path, final String allowedExtension,boolean showHidden) {
		...
		if (dirs != null) {
			...
			else for (File dir : dirs)if(!dir.isHidden()) list.add(dir);
		}
		...
		if (files != null) {
			...
			if(showHidden)
				for (File dir : files) list.add(dir);
				else for (File dir : files)if(!dir.isHidden()) list.add(dir);
